...
{
    public partial class ProductNameSelectForm : Form
    {
        ...
        public ProductNameSelectForm(MainForm mainForm, IUnitOfWork uow)
        {
            InitializeComponent();
        ...
        void subFunc_cbo_Mission1_Select_ListAdd()
        {
            try
            {
                ...
                foreach (var productName in uow.ProductNameInfos.GetAll())
                {
                        cbo_Mission1_Select.Items.Add(productName.ProductName);
                }
            }
            catch
            {
